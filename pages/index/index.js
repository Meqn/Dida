...
var app = getApp()
import DrawClock, {clockDraw, clockInit} from '../../utils/clock'
...
Page({
  data: {
    ...
    nav: [
      ...
      {url: '/pages/todo/index', text: '心愿单'},
      {url: '/pages/logs/logs', text: '日志'}
    ]
  },
  ...
  onReady: function() {
    ...
    console.log('... DrawClock ...', DrawClock, clockDraw)
